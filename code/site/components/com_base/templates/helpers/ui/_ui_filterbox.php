...
?>
<form  data-behavior="Request" data-request-options="{url:'<?=$search_action?>',update:'<?= $update_container ?>'}" id="an-search-form" class="an-filterbox" name="an-search-form"  method="GET">				
