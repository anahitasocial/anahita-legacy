 ...
 * @link       http://www.anahitapolis.com
 */
class LibBaseTemplateHelperMessage extends KTemplateHelperAbstract 
{    
    /**
     * Render the system queue messages
     * 
     * @return string
     */
    public function renderQueueMessages()
    {
        $messages = (array)JFactory::getApplication()->getMessageQueue();
